...
\item \textbf{Pantheon+ SNe}: 16 binned distance moduli at $0.01 \leq z \leq 1.80$ \cite{Scolnic2022}
...
\begin{itemize}
\item 2 independent chains $\times$ 30,000 samples each
\item Burn-in: 5,000 samples with adaptive proposal widths
\item Thinning: factor 3 (effective samples: 20,000)
\item Convergence: Gelman--Rubin $\hat{R} < 1.1$
\item Acceptance criterion: $\min(1, e^{-\Delta\chi^2/2})$
\end{itemize}
