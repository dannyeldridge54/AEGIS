...
export function createDashboard(port: number = 3333): DashboardServer {
  ...
  return {
    ...
    addLog(entry) {
      ...
      if (logEntries.length > 500) logEntries = logEntries.slice(-250);
    },
  };
}
 ...
 */
export function dashboardHandler(dashboard: DashboardServer) {
