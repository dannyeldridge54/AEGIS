...
\hline
$\mu^2$      & 188.35     & Mass parameter \\
$\lambda$    & 94.18      & Quartic self-coupling \\
$\gamma$     & 92.55      & Kinetic coefficient \\
$\varepsilon$& 15.19      & Curvature--torsion mixing \\
$\kappa_f$   & 4.01       & Fermion axial coupling \\
$\kappa_g$   & 7.71       & Graviton--torsion coupling \\
\hline
$\Tzero$     & 1.0000     & Background torsion field \\
$\Tvev$      & 0.9999     & Vacuum expectation value \\
$m_T$        & 27.49      & Torsion mass ($2\sqrt{\mu^2}$) \\
$\Tzero/\Tvev$ & 1.00003  & VEV alignment (5 sig.\ fig.) \\
\hline
\end{tabular}
\caption{Discovered UFE parameters. The field equation residual
is $9.5 \times 10^{-9}$, indicating an essentially exact solution.}
\label{tab:params}
\end{table}
...
Parameter & Value & \\
\hline
$H_0$        & 72.15 km/s/Mpc & Between Planck and SH0ES \\
$\Omega_m$   & 0.250          & Matter density \\
$\beta_0$    & $-0.150$       & Late-universe torsion \\
$\beta_1$    & $+0.192$       & Early-universe correction \\
\hline
\end{tabular}
...
\begin{enumerate}
  ...
  \item The cosmological $\chi^2$ fits use the same data for
    discovery and validation. Blind predictions against held-out
    data (e.g., DESI DR2, Euclid) are needed.
\end{enumerate}
